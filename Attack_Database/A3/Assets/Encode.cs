...
#if UNITY_EDITOR
[ExecuteInEditMode]
public class EmbeddingWatermark  : MonoBehaviour
{
    public string companyName ;
    private string inputPath = "Assets/Final/box.jpg"; // Input sprite path
    private string outputPath = "Assets/Final/box_embedded.jpg"; // Output path
